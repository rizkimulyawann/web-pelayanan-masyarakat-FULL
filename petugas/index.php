 ...
 ?>
  ...
  <html>
    <head>
      ...
      <link rel="shortcut icon" href="LOGO INSPEKTORAT.png">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><center><img class="circle" src="LOGO ACEH UTARA.png"></a></center>
                      <a href="https://www.instagram.com/inspektoratacut?utm_source=ig_web_button_share_sheet&igsh=OGQ5ZDc2ODk2ZA=="><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a> | Repost by <a href='https://inspektorat.acehutara.go.id/' title='Inspektorat Aceh Utara' target='_blank'>Inspektorat Aceh Utara</a>
