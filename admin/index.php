          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="https://www.instagram.com/andrea_zulfa?utm_source=ig_web_button_share_sheet&igsh=OGQ5ZDc2ODk2ZA=="><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a> | Repost by <a href='https://inspektorat.acehutara.go.id/' title='Inspektorat Aceh Utara' target='_blank'>Inspektorat Aceh Utara</a>
