...
<head>
	...
	<link href="libs/images/Lambang_kab_acehutara.png" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/Lambang_kab_acehutara.png" alt="logo-dkm" width="90" />
						</td>
						<td class="text-center" width="60%">
						<b>PEMERINTAH KABUPATEN ACEH UTARA</b> <br>
						<b>INSPEKTORAT</b><br>
						...
						<td class="text-right" width="20%">
							<img src="libs/images/corruption.png" alt="logo-dkm" width="100" height="85"/>
						</td>
					</tr>
				</tbody>
			</table>
